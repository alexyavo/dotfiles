...
;; in dracula-theme.el edit:
;; (dracula-fg      "#C0C5CE" "#C0C5CE" "brightwhite") ; official foreground
;; to make the white easier on the eyes
...
(use-package evil :ensure t
  ...
  :config
  (evil-set-undo-system 'undo-redo)  ;; emacs28, prev ver can use undo-tree (?)
  (evil-mode t))
